...
const DEFAULT_REGISTRY
  = 'https://raw.githubusercontent.com/nyxb/starter/templates/templates'
   ...
   async run(ctx) {
      ...
      try {
         template = await downloadTemplate(templateName, {
            ...
            registry: process.env.NYXBI_INIT_REGISTRY || DEFAULT_REGISTRY,
         })
      }
      catch (err) {
    ...
    git --git-dir=${template.dir}/.git --work-tree=${template.dir} commit -m "🔰 This is where it all begins..."
`, {
            stdio: 'inherit',
            shell: true,
         }).catch((err) => {
